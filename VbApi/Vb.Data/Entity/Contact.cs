...
namespace Vb.Data.Entity
{
    ...
    public class ContactConfiguration : IEntityTypeConfiguration<Contact>
    {
        public void Configure(EntityTypeBuilder<Contact> builder)
        {
            ...
            builder.HasIndex(x => new { x.Information, x.ContactType }).IsUnique(true); // tablo'da unique olması gerekenler --- burada mutlaka yapılmalı, api async çalıştığı için veri kaçağı olabilir. En garanti db'de de unique yapmak gerekir.
        }
    }
}
